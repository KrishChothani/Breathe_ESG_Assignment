/**
 * Footer.jsx — Light enterprise footer
 */
...
export default function Footer() {
  return (
    <footer className="border-t border-slate-200 pt-16 pb-8 px-6 bg-white">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-10 mb-14">
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4 group w-fit">
              ...
              <span className="text-slate-900 font-bold text-base tracking-tight">BreatheESG</span>
            </Link>
            ...
            <div className="flex gap-3 mt-5">
              {['twitter', 'linkedin', 'github'].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-8 h-8 rounded-lg border border-slate-200 bg-white flex items-center justify-center text-slate-400 hover:text-blue-600 hover:border-blue-300 transition-all shadow-sm"
                >
          ...
          {Object.entries(footerLinks).map(([group, links]) => (
            <div key={group}>
              <h3 className="text-xs font-bold text-slate-900 uppercase tracking-widest mb-4">{group}</h3>
